...
/**
 * AppserverIo\Lab\MemcacheProtocol\MemcacheConnectionHandler
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\Lab\MemcacheServer\MemcacheServer;
use AppserverIo\Lab\MemcacheServer\GarbageCollector;
...
class MemcacheConnectionHandler implements ConnectionHandlerInterface
{
     ...
     *
     * @var \AppserverIo\Lab\MemcacheServer\MemcacheServer
     */
    protected $cache;
     ...
     *
     * @var \AppserverIo\Lab\MemcacheServer\GarbageCollector
     */
    protected $gc;
     ...
     *
     * @return \AppserverIo\Lab\MemcacheServer\CacheInterface The cache API implementation.
     */

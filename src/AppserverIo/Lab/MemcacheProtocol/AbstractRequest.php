...
/**
 * AppserverIo\Lab\MemcacheProtocol\AbstractRequest
 *
 * NOTICE OF LICENSE
 *
...
abstract class AbstractRequest implements CacheRequestInterface
{
     ...
     *
     * @return void
     * @see \AppserverIo\Lab\MemcacheProtocol\CacheRequest::reset()
     */
     ...
     * @see \AppserverIo\Lab\MemcacheProtocol\CacheRequest::getComplete()
     */
